...
func (ec *executionContext) fieldContext_Location_photo(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Location",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Query_locations(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNLocation2ᚕᚖgithubᚗcomᚋYYdesoulᚋtemplateᚑapolloᚑfederationᚑwithᚑgoᚋsubgraphᚑlocationsᚋgraphᚋmodelᚐLocationᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_location(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Location)
	fc.Result = res
	return ec.marshalOLocation2ᚖgithubᚗcomᚋYYdesoulᚋtemplateᚑapolloᚑfederationᚑwithᚑgoᚋsubgraphᚑlocationsᚋgraphᚋmodelᚐLocation(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNLocation2ᚕᚖgithubᚗcomᚋYYdesoulᚋtemplateᚑapolloᚑfederationᚑwithᚑgoᚋsubgraphᚑlocationsᚋgraphᚋmodelᚐLocationᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Location) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNLocation2ᚖgithubᚗcomᚋYYdesoulᚋtemplateᚑapolloᚑfederationᚑwithᚑgoᚋsubgraphᚑlocationsᚋgraphᚋmodelᚐLocation(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNLocation2ᚖgithubᚗcomᚋYYdesoulᚋtemplateᚑapolloᚑfederationᚑwithᚑgoᚋsubgraphᚑlocationsᚋgraphᚋmodelᚐLocation(ctx context.Context, sel ast.SelectionSet, v *model.Location) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOLocation2ᚖgithubᚗcomᚋYYdesoulᚋtemplateᚑapolloᚑfederationᚑwithᚑgoᚋsubgraphᚑlocationsᚋgraphᚋmodelᚐLocation(ctx context.Context, sel ast.SelectionSet, v *model.Location) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Location(ctx, sel, v)
